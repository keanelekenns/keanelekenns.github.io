          ...
          return void 0 === e
            ...
            : e.read().then(function (e) {
                if (e.done) {
                  ...
                  for (
                    var t = new Uint8Array(h), n = (t.set(u, 0), f), r = 0;
                    r < l.length;
                    ++r
                  )
    ...
    (l.UnityCache =
      ...
      (P.prototype.cleanUpCache = function () {
        ...
        return this.getMetaDataEntries().then(function (e) {
          ...
          for (a = 0; a < o.length && !(n < P.MaximumCacheSize); ++a)
      ...
      (l.addRunDependency("dataUrl"),
        e.then(function (e) {
          ...
          for (n += 4; n < o; ) {
            ...
            n += s;
            for (
              var d = 0, u = c.indexOf("/", d) + 1;
              0 < u;
              d = u, u = c.indexOf("/", d) + 1
            )
              l.FS_createPath(c.substring(0, d), c.substring(d, u - 1), !0, !0);
